...
Cells(locationEficency, locationAvgCol) = "sequential"
Cells(locationEficency, locationAvgCol + 1) = "1 thread"
Cells(locationEficency, locationAvgCol + 2) = "2 threads"
Cells(locationEficency, locationAvgCol + 3) = "4 threads"
Cells(locationEficency, locationAvgCol + 4) = "6 threads"
Cells(locationEficency, locationAvgCol + 5) = "8 threads"
Cells(locationEficency, locationAvgCol + 6) = "12 threads"
...
For Col = 1 To numberOfColumns - 2
    For Row = 1 To tests
        ...
        eficency = Cells(locationSpeedUp + Row + 1, locationAvgCol + Col + 1).Value /
        Cells(locationEficency + Row + 1, locationAvgCol + Col + 1).Value = locationEficency
    Next
Next
